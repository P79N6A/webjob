...
public class Page implements java.io.Serializable {
	...
	public void debug1() {
		...
		String debug = "共有数据数:" + totalRows + "共有页数:" + totalPages + "当前页数为:" + currentPage + "是否有前一页:"
				+ hasPreviousPage + "是否有下一页:" + hasNextPage + "开始行数:" + pageStartRow + "终止行数:" + pageEndRow;
	...
	public void setPagedView() {
		...
		StringBuffer sb = new StringBuffer();
		sb.append("<table width='100%' class='cms_pageform' cellpadding='0' cellspacing='0'>");
		sb.append("<tbody>");
		sb.append("<tr>");
		...
		if (hasPreviousPage) {
			sb.append(
					"[<a href=\"javascript:search_pagedForm(1);\" style= \"text-decoration:none; \">首&nbsp;&nbsp;页</a>]");
			sb.append("&nbsp;&nbsp;");

			sb.append("[<a href=\"javascript:search_pagedForm(" + (currentPage - 1)
					+ ");\" style= \"text-decoration:none; \">上一页</a>]");
		} else {
			sb.append(
					"[<a href=\"javascript:search_pagedForm(1);\" style= \"text-decoration:none; \">首&nbsp;&nbsp;页</a>]");
			sb.append("&nbsp;&nbsp;");
			sb.append("[<a href=\"javascript:search_pagedForm(1);\" style= \"text-decoration:none; \">上一页</a>]");
		}
		sb.append("&nbsp;&nbsp;");
		if (hasNextPage) {
			sb.append("[<a href=\"javascript:search_pagedForm(" + (currentPage + 1)
			...
			sb.append("&nbsp;&nbsp;");
			sb.append("[<a href=\"javascript:search_pagedForm(" + totalPages
		...
		sb.append("</td>");
		sb.append("<td align=right width='33%'>");

		sb.append("总数: " + totalRows + ", 共" + totalPages + "页, 第" + currentPage + "页 ");
		sb.append("<input type=hidden size=10 name=page value=" + currentPage + " class='form'  style='width:30px;'>");
		sb.append("&nbsp;");
		sb.append("&nbsp;<input type=hidden size=10 name=pageSize value=" + pageSize
				+ " class='form' style='width:30px;'>");
		sb.append("<input name=totalPages type=hidden value='" + totalPages + "'>");
		sb.append("&nbsp;&nbsp;");
		sb.append("<input name=totalRows type=hidden value='" + totalRows + "'>");
